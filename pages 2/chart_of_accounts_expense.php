        	...
        	<div class="row">
			   ...
			   <tbody>
			   	...
			   	<tbody>			
			   	   		 ...
			   	   		 <?php 
			   	   		  $query = "SELECT * FROM chartofaccounts WHERE Type='Expenses' ORDER BY Liquidity"; 
			   ...
			   <!-- <tbody>			   	
			   	<tr><th scope="row" span title="Account number identification in general ledger">726</th><td><abbr title='Click on account to view and keep track of changes in balances'><a href="inledger.php">Wages Expenses</a></abbr><br></br><span style="color:#868686;">Payment to employees</span></td><td>Expense</td><td>Expenses</td>
			   	<?php
			   			$query = "SELECT * FROM chartofaccounts WHERE AccountName='Wages Expenses'"; 
						  $results = mysqli_query($cxn, $query);			  
						  while ($row = mysqli_fetch_assoc($results))
						  {
			   	...
			   	<tr><th scope="row" span title="Account number identification in general ledger">727</th><td><abbr title='Click on account to view and keep track of changes in balances'><a href="inledger.php">Automobile Expenses</a></abbr><br></br><span style="color:#868686;">Expenses incurred on the running of company automobiles</span></td><td>Expense</td><td>Expenses</td>
			   	<?php
			   			$query = "SELECT * FROM chartofaccounts WHERE AccountName='Automobile Expense'"; 
						  $results = mysqli_query($cxn, $query);			  
						  while ($row = mysqli_fetch_assoc($results))
						  {
						  $balance = getAccountBalance($row['AccountName']);
			   	...
			   	<tr><th scope="row" span title="Account number identification in general ledger">729</th><td><abbr title='Click on account to view and keep track of changes in balances'><a href="inledger.php">Rent Expenses</a></abbr><br></br><span style="color:#868686;">The payment to lease area/building</span></td><td>Expense</td><td>Expenses</td>
			   	<?php
			   			$query = "SELECT * FROM chartofaccounts WHERE AccountName='Rent Expenses'"; 
						  $results = mysqli_query($cxn, $query);			  
						  while ($row = mysqli_fetch_assoc($results))
						  {
						  $balance = getAccountBalance($row['AccountName']);
			   	...
			   	<tr><th scope="row" span title="Account number identification in general ledger">730</th><td><abbr title='Click on account to view and keep track of changes in balances'><a href="inledger.php">Telephone Expenses</a></abbr><br></br><span style="color:#868686;">Expenditure incurred from business-related phone calls and phone lines</span></td><td>Expense</td><td>Expenses</td>
			   	<?php
			   			$query = "SELECT * FROM chartofaccounts WHERE AccountName='Telephone Expenses'"; 
						  $results = mysqli_query($cxn, $query);			  
						  while ($row = mysqli_fetch_assoc($results))
						  {
						  $balance = getAccountBalance($row['AccountName']);
			   	...
			   	<tr><th scope="row" span title="Account number identification in general ledger">731</th><td><abbr title='Click on account to view and keep track of changes in balances'><a href="inledger.php">Professional Fees</a></abbr><br></br><span style="color:#868686;">Fee charged for services from professionals</span></td><td>Expense</td><td>Expenses</td>
			   	<?php
			   			$query = "SELECT * FROM chartofaccounts WHERE AccountName='Professional Fees'"; 
						  $results = mysqli_query($cxn, $query);			  
						  while ($row = mysqli_fetch_assoc($results))
						  {
						  $balance = getAccountBalance($row['AccountName']);
			   	...
			   	<tr><th scope="row" span title="Account number identification in general ledger">732</th><td><abbr title='Click on account to view and keep track of changes in balances'><a href="inledger.php">Utility Expenses</a></abbr><br></br><span style="color:#868686;">Expenses incurred for lighting, powering and/or other utilities</span></td><td>Expense</td><td>Expenses</td>
			  <?php
			   			$query = "SELECT * FROM chartofaccounts WHERE AccountName='Utility Expenses'"; 
						  $results = mysqli_query($cxn, $query);			  
						  while ($row = mysqli_fetch_assoc($results))
						  {
						  $balance = getAccountBalance($row['AccountName']);
