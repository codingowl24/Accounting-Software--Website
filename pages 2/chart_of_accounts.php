        	...
        	<div class="row">
			   ...
			   <thead>
			   	<tr>
			   		...
			   		<th class = "col-lg-5">Name of Account</th>			   		
			   		<th class = "col-lg-1"><a href="chart_orderby_code.php">Code
			   ...
			   <tbody>			
			   	   		 ...
			   	   		 <?php 
			   	   		  $query = "SELECT * FROM chartofaccounts ORDER BY Liquidity"; 
						  ...
						  echo"<td class = 'col-lg-1'><abbr title='Click on account to view and keep track of changes in balances'><a href='$String'>".$row['AccountName']."</a></abbr></td>";	
						  ...
						  echo"<td class = 'col-lg-1' align='right'>$balance </td>";	
