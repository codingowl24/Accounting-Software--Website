        	...
        	<div class="row">
                        ...
                        <div class="panel-heading">                            
                            <!-- <div class="row show-grid"> -->
                            	<ul class="nav nav-tabs">
								  ...
								  <li role="presentation" class="active"><a href="#">Liabilities</a></li>
			   ...
			   <tbody>
			   	...
			   	<tbody>			
			   	   		 ...
			   	   		 <?php 
			   	   		  $query = "SELECT * FROM chartofaccounts WHERE Type='Liability' ORDER BY Liquidity"; 
			   ...
			   <!-- <tbody>
			   	<?php
											...
											$String = 'inledger.php?AccountName=NotesPayable';
				
			  	echo "<tr>";
			  	echo "<th scope='row' span title='Account number identification in general ledger'>200";
			  	echo "</th>";
			  	echo "<td>";
			  	echo "<abbr title='Click on account to view and keep track of changes in balances'>";
			  	echo "<a href='$String'>Notes Payable";
			  	echo "</a>";    ?>
			  	</abbr><br></br><span style="color:#868686;">Formal note the company had received from loaners but had not paid yet</span></td><td>Current Liability</td><td>Liability</td>
			  
			  
			  <?php
			   			$query = "SELECT * FROM chartofaccounts WHERE AccountName='Notes Payable'"; 
						  $results = mysqli_query($cxn, $query);			  
						  while ($row = mysqli_fetch_assoc($results))
						  {
						  $balance = getPeriodAmount($row['AccountName']);
			   	...
			   	<tr><th scope="row" span title="Account number identification in general ledger">201</th><td><abbr title='Click on account to view and keep track of changes in balances'><a href="inledger.php">Accounts Payable</a></abbr><br></br><span style="color:#868686;">Invoices the company had received from suppliers but has not paid yet</span></td><td>Current Liability</td><td>Liability</td>
			  <?php
			   			$query = "SELECT * FROM chartofaccounts WHERE AccountName='Accounts Payable'"; 
						  $results = mysqli_query($cxn, $query);			  
						  while ($row = mysqli_fetch_assoc($results))
						  {
						  $balance = getPeriodAmount($row['AccountName']);
