                    ...
                    <div class="col-lg-12" align="center">
                    	...
                    	<div class="panel panel-info" style="width:700px" align="center">
								...
								<div class="row">
									...
									$querya = mysql_query("Select id, title, timestamp, user1, user2, message from pm where id = '$mailid' AND user1 = '$login_username'");
									...
									echo "<tr >";
									echo "<td class='col-lg-1' >$ti</td>";
									echo "</tr>";
									echo "<tr>";
									echo "<td class='col-sm-1' style='width:5%'><i class='fa fa-user'></i> $u1  </td>";
									echo "</tr>";
									echo "<tr>";
									echo "<td class='col-sm-1' style='width:5%'>To $u2  </td>";
									echo "</tr>";
									
									echo "<tr>";
									echo "<td class='col-lg-9'>$mess </td>";
									echo "<td class='col-lg-1' >$timestamp </td>";
