                    ...
                    <div class="col-lg-12" align="center">
                    	...
                    	<div class="panel panel-info" style="width:700px" align="center">
								<div class="panel-heading">
									<h3 class="panel-title" align="center"><i class="fa fa-envelope"></i> <b>Inbox</b></h3>
								</div>
								<br>
							...
							$querya = mysql_query("Select pm.id, pm.title, pm.timestamp, pm.user1, pm.user2, pm.message, pm.userread 
												   from pm where pm.user2 = '$login_username' order by pm.timestamp desc");
							...
							echo "<form action='' method='POST'>";
									...
									<input type='checkbox' name='mailcheck[]' value='$mailid' /><br />
									...
									if($read == 0){
									echo "<td class='col-lg-3' ><a href='$StringURL' onclick='openRequestedPopup();'><font color='Tomato '><b>$ti</b> </font> </a></td>";
									}
									else{
								...
								echo "
								<input type='submit' name='Delete' value='Delete' onclick='return Delete();'>
								...
								<?php
								 	...
								 	if (isset($_POST['Delete']))
								 {
									...
									foreach($_POST['mailcheck'] as $mail){
										mysql_query("Delete from pm where id = '$mail' ");		
											
										
									//	echo "'$mail'". " ";
					
									 }
								//	 echo $_POST['mailcheck'];
