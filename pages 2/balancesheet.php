...
<head>
    ...
    <title>Balance Sheet - TMT Finance</title>
                    ...
                    <div class="col-lg-12" align="center">
                    	...
                    	<div class="panel panel-info" style="width:700px" align="center">
								<div class="panel-heading">
									...
									<h2 class="panel-title" align="center">Balance Sheet</h2>
								...
								<div class="row" align="center">
										<table  style="width:50px" >
											<thead>
											<td class='col-lg-1' colspan="4" style="border-bottom: solid"><h4>Assets</h4></td>
									...
									<table class="tbl" >
											...
											$querya ="SELECT * FROM chartofaccounts WHERE Type= 'Assets' and Balance !='0' order by Liquidity asc ";
											...
											while ($rowA=mysqli_fetch_assoc($resultsa)){
												...
												echo "<td class='col-lg-4'>".$rowA['AccountName']."</td>";
                                                ...
                                                if($act == $num_rows-1){
                                                    ...
                                                    if($rowA['AccountName'] == 'Equipment Accumulated Depreciation'){
                                                        echo "<tr></tr>";
                                                        $totalasset= $totalasset - $rowA['Balance'];
                                                        $act = $act+1;
                                                    }else{
											...
											echo "<td class='col-lg-1' style='padding-left:40px;'>Total Assets</td>";
											echo "<td class='col-lg-1'><label></label></td>";
											$totala=number_format($totalasset,2);
											echo "<td class='col-lg-1' style='border-bottom:double' align='right'>$ $totala</td>";
										...
										<table style="width:270px; display:inline-block">
											<thead>
											
											<td class='col-lg-1' colspan="4" style="border-bottom: solid"><h4>Liabilities and Owner's Equity</h4></td>
											</thead>
										</table>
									<style>
										.tbl{
									...
									<table class="tbl" >
											...
											echo "<td class='col-lg-1'>Liabilities</td>";
											echo "<td class='col-lg-1'><label></label></td>";
											echo "<tr></tr>";


											$queryl ="SELECT * FROM chartofaccounts WHERE Type = 'Liability' and Balance !='0'";
											$resultsl = mysqli_query($cxn, $queryl) or die(mysqli_error($cxn));
											$totalsum=0;
                                            $act = 0;
											
											

											while ($rowL=mysqli_fetch_assoc($resultsl)){
												if($rowL['Balance']!='0.00'){
												$name = $rowL['AccountName'];
												...
												echo "<td class='col-lg-1' style='padding-left:40px;'>".$rowL['AccountName']."</td>";
												echo "<td class='col-lg-1'><label></label></td>";
											...
											echo "<td class='col-lg-1'>Owner's Equity</td>";
											echo "<td class='col-lg-1'><label></label></td>";
											echo "<tr></tr>";
                                        ...
                                        $querya ="SELECT * FROM chartofaccounts WHERE Type= 'Revenues' and Balance !='0'";
                                        $resultsa = mysqli_query($cxn, $querya) or die(mysqli_error($cxn));
                                        $totalrevenues=0.00;
                                        ...
                                        $queryb ="SELECT * FROM chartofaccounts WHERE Type= 'Expenses' and Balance !='0'";
                                        ...
                                        $namea = "Investments";
                                        $investment = getAccountBalance($namea);

                                        $nameb = "Drawings";
                                        $drawing3 = getAccountBalance($nameb);
                                        $drawing = -$drawing3;



                                        $queryc ="SELECT * FROM chartofaccounts WHERE AccountName= 'Capital' and Balance !='0'";
                                        $resultsc = mysqli_query($cxn, $queryc) or die(mysqli_error($cxn));
                                        $rowC=mysqli_fetch_assoc($resultsc);

                                        $num_rows = mysqli_num_rows($resultsc);
                                        $act = 0;

                                        $ownerequity = $netincome + $investment - $drawing + $rowC['Balance'] ;
                                        $ownerequitya = -$ownerequity;
                                        // $ownerequityf=number_format($ownerequitya,2);


                                        echo "<td class='col-lg-1' style='padding-left:40px;'>Owner's Capital</td>";
										echo "<td class='col-lg-1'><label></label></td>";
										...
										echo "<td class='col-lg-1' style='border-bottom:1px solid' align='right'> $oo</td>";

  

										echo "<tr></tr>";
										echo "<td class='col-lg-3' style='padding-left:80px;'>Total liabilities and owner’s equity</td>";

										echo "<td class='col-lg-1'><label></label></td>";
                                        $totalsum += $ownerequity;
                                        $totalsuma = -$totalsum;
										// $totals=number_format($totalsuma,2);
                                        if($totalsuma<'0')
                                                    {
                                                        $o = -$totalsuma;
                                                        $oo1=number_format($o,2);
										...
										echo "<td class='col-lg-1' style='border-bottom:double' align='right'>$ $oo</td>";
										echo "<tr></tr>";
