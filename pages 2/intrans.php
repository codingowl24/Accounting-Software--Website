            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <input type = 'image' src = 'images/arrow2.png' name = 'image' width = '50' height = '50' onclick='history.go(-1)'>
                       <?php  echo "<h1 class='page-header'>Entry Number:  ".$_GET["Entrynumber"]."</h1>"; 
                        ...
                        <div class="panel panel-default">
	            			<div class="">
	            				...
	            				<?php
                                    ...
                                    echo "</h3>";
                                    echo "<h4  style='text-align: right;'>".$_GET["Entrynumber"]."</h4>";
                                    ...
                                    echo "<tbody>";
									echo "<tr>";
                                    $querya ="SELECT * FROM GenJournal WHERE Entry= '$entrynumber' ";
