...
<body>
 ...
 <div class="search" style="padding-bottom: 10px; width: 300px" >
 	<br>
					            		...
					            		<input class="form-control"  id="dp" type="text" />
					            		</form>	
					            		</div>
                            ...
                            <div class="input-group custom-search-form">
                                ...
                                <input type="text" id='dp1' class="form-control input-md" placeholder="Search User..." name="finduser" >
