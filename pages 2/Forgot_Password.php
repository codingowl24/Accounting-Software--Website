<?php
require ('Config.php');
include 'forgotpasswordgenerator.php';										
?>
                    ...
                    <div class="panel-body">
                        <form role="form" action="forgot_password.php" method='POST'>
                            <fieldset>
                                ...
                                <input type="submit" name="resendpass" value="Resend Password" class="btn btn-lg btn-primary" style="width:95%" >
                  				<span class="error"><font color="red"><b><?php echo $Error;?></b></font></span>
                                <span class="success"><b><?php echo $successMessage;?></b></font></span>
